...
const CompassIcon = (props) => (
  ...
  >
    <path
      ...
      d="m16.5 7.5-2.25 6.75L7.5 16.5l2.25-6.75zM21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0ZM12 12v.01"
    />
  </svg>
);
    ...
    <div className="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6 h-full">
      <div className="flex h-16 shrink-0 items-center py-[46px]">
        ...
        <svg
          ...
          className="x1lliihq x1n2onr6 x5n08af" fill="currentColor"
          height="29"
          role="img"
          viewBox="32 4 113 32"
          width="103"
      ...
      <nav className="flex flex-1 flex-col">
        <ul role="list" className="flex flex-1 flex-col gap-y-7">
          <li>
            <ul role="list" className="-mx-2 space-y-3.5">
              {navigation.map((item) => (
                <li key={item.name}>
                  {!item.children ? (
                    <Link
